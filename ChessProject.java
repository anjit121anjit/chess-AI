	...
	*/
	private Boolean checkWhiteOponent(int newX, int newY){
      ...
      if(tmp1.contains("King")){
			        JOptionPane.showMessageDialog(null,"Congrats, White Wins :) \n Game Over !");
			        System.exit(0);
      }
		}
		else{
  ...
  */
  private Boolean checkBlackOponent(int newX, int newY){
    ...
    if(((tmp1.contains("White")))){
      oponent = true;
      if(tmp1.contains("King")){
				        JOptionPane.showMessageDialog(null,"Congrats, Black Wins :) \n Game Over !");
				        System.exit(0);
      }
    }
    else{
    ...
    return oponent;
                    ...
                    private Boolean closedKing(int x, int y)
                      {
...
//......King Move here.
    if(pieceName.contains("King")){
      //below statement check if the piece on its placed on board
      Boolean InTheWay = false;
      int distance = Math.abs(startX-landingX);

      if (((landingX <0) || (landingX > 7)) || ((landingY <0) || (landingX > 7))){
        validMove =false;
      }
      else {
      ...
      if(((yMovement ==1)&&(xMovement ==1)) ||((xMovement ==0)&&(yMovement==1)) || ((xMovement==1) &&(yMovement==0))) {

                if (!(closedKing (e.getX(),e.getY()))){
          validMove = true;
                //start rook .........
      ...
      } // Rook contains done here now take the moves from bishop to make a diagonal one move for king
...
/*.............................................Queen Move........ */
          ...
          int distance = Math.abs(startX-landingX);
          /*
          if the queen is being plcaed back onto the board
          if the movemnt is like a bishop
          test for a valid moved
            we have a valid movement if the xMovement == yMovement
              if there is something in the way
              if there is a piece oon the expected landing square,if so make sured
              its an enemy piece
                  */

                  if(((landingX < 0) || (landingX >7)) ||((landingY <0) || (landingY > 7))){ //move stay on the board
                    validMove = false;
                  }

                    if(Math.abs(startX-landingX) == Math.abs(startY-landingY)){
                      if((startX-landingX <0) &&(startY-landingY <0)){
                        for(int i=0; i< Math.abs(startX-landingX); i++){
                          if(piecePresent((initialX+(i*75)), (initialY+(i*75)))){
                            inTheWay = true;
                          }
                        }
      ...
      /*    else if the movement is like the Rook
          ...
          test for a vlaid Rook movement.
              if there is an xMovement there cant be a yMovement
              if there is a yMovement there cant be an xMovement

              if one of the above conditions are true we simply make that there
              is nothing on the way and that we cannot take our own piece.
          */
            ...
            if(Math.abs(startX-landingX)!=0){
              ...
              //queen finally done here...........
              //BlackPawn and WhitePawn start here...
      ...
      if(startY == 6){ // this is were the pawn is making its first move
        ...
        as long as we are moving up the board !!!! and also there is no movement
        in the x direction
        */
      ...
      else{ // this is were the pawn is making all subsequence move...
        ...
        // Black pawn working and done......
        // White pawn starts here....
      ...
      if (pieceName.contains("Bishop")){
        Boolean inTheWay = false;
        int distance = Math.abs(startX-landingX);
        // check if the piece is back on the board
